...
vxScene.a: vxAction.o vxScene.o vxDrawSphere.o vxDrawPlane.o vxDrawSurface.o vxValidatable.o vxColor.o vxColorLookupTable.o vxSmoothBell.o vxFileGzipIo.o vxFastVolume.o vxTextured.o vxDrawSurface.o vxSurface.o vxVector.o vxProjection.o vxMotion.o vxOpenGlTools.o vxRay.o vxRange.o vxLighting.o vxMouseRay.o vxFontFtgl.o vxBinaryBlobs.o vxSurfaceSlicer.o
